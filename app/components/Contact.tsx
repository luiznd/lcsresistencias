  ...
  return (
    <section id="contact" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  placeholder={CONTACT.phone.replace('7745', '9999')}
                />
              </div>
          ...
          <div>
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`tel:${CONTACT.phone}`} className="text-gray-900 font-medium hover:text-orange-600">{CONTACT.phone}</a>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`mailto:${CONTACT.email}`} className="text-gray-900 font-medium hover:text-orange-600">{CONTACT.email}</a>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(CONTACT.address)}`} target="_blank" rel="noopener noreferrer" className="text-gray-900 font-medium hover:text-orange-600">{CONTACT.address}</a>
            ...
            {/* Botão WhatsApp */}
            <a
              href={CONTACT.social.find(s => s.name === 'WhatsApp')?.url || '#'}
              target="_blank"
      ...
      <div className="container mx-auto px-4 mt-12">
        ...
        <p className="text-gray-700 mb-4">{CONTACT.address}</p>
        <div className="relative w-full h-[320px] md:h-[420px] rounded-2xl overflow-hidden border border-gray-200">
          <iframe
            ...
            src={`https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${encodeURIComponent(CONTACT.address)}`}
            width="100%"
            height="100%"
            style={{ border: 0 }}
            loading="lazy"
