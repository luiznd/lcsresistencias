          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(CONTACT.address)}`} target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-accent-400">
                    {CONTACT.address}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href={`tel:${CONTACT.phone}`} className="text-slate-300 hover:text-accent-400">{CONTACT.phone}</a>
              </div>
              
              <div className="flex items-center space-x-3">
                <EnvelopeIcon className="w-5 h-5 text-accent-400 flex-shrink-0" />
                <a href={`mailto:${CONTACT.email}`} className="text-slate-300 hover:text-accent-400">{CONTACT.email}</a>
              </div>
